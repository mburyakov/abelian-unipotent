...
Есть предположение, что утверждение \ref{unipotentsubgroups} эквивалентно свойству \ref{returnfromhighest}. Действительно, пусть $u \in U_\sigma$. Тогда, если подмодуль, порождаемый  $u$ (как $E$-инвариантный подмодуль), имеет вид $U \cdot I$, то его образы в $U_{\widetilde\sigma}$ под действием цепочек операторов из \ref{returnfromhighest} также будут лежать в $U \cdot I$. При этом если они при этом будут лежать в $U \cdot J$, где $J$ --- некоторый меньший идеал, то 
