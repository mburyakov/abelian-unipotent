...
\filltitle{ru}{
    chair              = {\hspace{8em} 01.04.01 Математика \textcolor{white}{\tiny ---  царица \xcancel{полей} ${}^{\text{\textit{коммутативных колец}}}$}},
    title              = {Линейные алгебраические группы параболического типа},
    type               = {master},
    position           = {студента},
...
\filltitle{en}{
    chair              = {01.04.01 Mathematics},
    title              = {Parabolic-like Linear Algebraic Groups},
    type               = {master},
    position           = {студента},
    author             = {Mikhail~Buryakov},
    supervisorPosition = {Dr. of Sc. (Phys.-Math.), Prof.},
    supervisor         = {Nikolai~Vavilov},
    reviewerPosition   = {Cand. of Sc. (Phys.-Math.), Assoc. Prof.},
    reviewer           = {Igor~Pevzner},
...
Тогда если $V$ и $U/V$ --- неприводимые над замкнутым полем характеристики $0$ представления группы $G$, для которых с учётом выбора кольца $R$ выполняется свойство \refb{returnfromhighest}, то подгруппы унипотентного радикала, нормализуемые $E$, задаются парой идеалов $I$, $J$, где $I^2 \subset J$.
\end{thm}
\begin{proof}
