...
%\draw[olive] ({sqrt(2)},{-2.3*sqrt(2)}) ++(0:0.3) -- ++(90:{0.3*sqrt(2)}) to[bend right=45] ({sqrt(2)},{-2*sqrt(2)+0.3}) -- +(-180:{sqrt(2)}) to[bend right=22.5] ({-0.3/sqrt(2)},{-2*sqrt(2)+0.3/sqrt(2)}) -- +(-90-45:0.9);
