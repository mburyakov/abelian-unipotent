...
Пусть $\Phi=\Phi_1+\ldots+\Phi_n$ --- система корней с неприводимыми компонентами ранга не менее $2$, $\sigma$ --- некоторый доминантный вес, такой что $\sigma-\beta$ не ортогонально $\Phi_i$.

Тогда максимальный корень $\beta\coloneqq\widetilde\beta_i$ можно представить в виде суммы двух корней $\gamma$ и $\delta$ одинаковой длины, так любая положительная комбинация корней $\beta$ и $-\gamma$ будет неотрицательна. Если же $\langle\sigma-\beta,\beta\rangle=0$, то выбор можно совершить таким образом, чтобы дополнительно выполнялось $\langle\sigma,\delta-\gamma\rangle>0$.

Заметим, что угол между $\gamma$ и $\delta$ в результате может оказаться либо $\frac{\pi}{2}$, либо $\frac{2\pi}{3}$. Угол $\frac{\pi}{3}$ (когда $\Phi = \mathrm{G}_2$) невозможен, так как тогда нарушится условие $\N\beta-\N\gamma \nprec 0$.
\end{lm}
\begin{proof}
...
В случае, когда $\langle\sigma-\beta,\beta\rangle=0$, обеспечить выполнения условия $\langle\sigma,\delta-\gamma\rangle>0$ можно следующим образом. Выберем корень $\delta$, не ортогональный ни $\beta$, ни $\sigma-\beta$ (это можно сделать, так как $\Phi$ неприводима и в $\Phi$ есть корень, не ортогональный $\sigma-\beta$). Не умаляя общности можно считать, что $\langle\delta,\beta\rangle>0$ и $\langle\delta,\sigma-\beta\rangle>0$. Тогда $\langle\delta,\beta\rangle=\frac{1}{2}\langle\beta,\beta\rangle$ и $\gamma\coloneqq\beta-\delta$. При этом
...
\begin{thm}
  ...
  с системой корней $\Phi = \Phi_1 + \ldots + \Phi_n$, где каждая $\Phi_i$ --- неприводимая система корней ранга не меньше $2$. $U$ --- неприводимое рациональное представление $G$ (модуль Вейля), такое что его старший вес $\widetilde\sigma$ не ортогонален ни одной из компонент $\Phi_i$. В коммутативном кольце $R$ предполагается обратимость всех структурных констант группы $G$, а также предполагается выполнение свойства \ref{returnfromhighest}.
...
Пусть $\sigma$ --- минимальный корень из присутствующих в разложении $u'$. Для некоторого положительного корня $\alpha_1$ вычислим
\begin{multline*}
